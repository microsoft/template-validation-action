...
class TestParseRules(unittest.TestCase):
    ...
    def test_parse_playwright_validator(self, mock_file, find_playwright_config_ts_path):
        find_playwright_config_ts_path.return_value = ["mocked/path/to/playwright.config.ts"]
        args = argparse.Namespace(
            validate_azd=False,
        ...
        self.assertEqual(playwright_test_validator.folderPath, "mocked/path/to/playwright.config.ts")
    ...
    def test_parse_playwright_validator_empty(self, mock_file, find_playwright_config_ts_path):
