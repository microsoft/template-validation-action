...
class TestParseRules(unittest.TestCase):
    ...
    def test_parse_rules(self, mock_file):
        args = argparse.Namespace(azdup=True, azddown=True, topics="azd-templates,azure")
        ...
        self.assertEqual(file_validator.h2Tags, [
            "## Features",
            "## Getting Started",
            "## Guidance",
            "## Resources"
        ...
        self.assertEqual(topic_validator.expected_topics, ["azd-templates", "ai-azd-templates"])
